...
const string strMessageMagic = "Seedbit Signed Message:\n";
...
int64_t GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime)
{
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "seedbit", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1432136475;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 13951325;
		if (fTestNet)
		{
			block.nNonce = 14007547;
		}
        	
        assert(block.hashMerkleRoot == uint256("0xdf7b739a6fe978a3da8d28df02dfc232ec59eb8b41a65cec128a25d5444c0ed1"));
